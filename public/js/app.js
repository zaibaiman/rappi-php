...
var basketModal = new Vue({
    ...
    methods: {
        addItem: function addItem(id, name, price, imageUrl) {
            this.items.push({
                id: id,
                name: name,
                price: price,
...
var productModal = new Vue({
    ...
    methods: {
        ...
        add: function add() {
            basketModal.addItem(this.selectedProduct.id, this.selectedProduct.name, this.selectedProduct.price, this.selectedProduct.imageUrl);
